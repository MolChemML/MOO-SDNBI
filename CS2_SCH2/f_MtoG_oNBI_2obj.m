...
function [objs, n_groups, properties, tWall, tCPU] ...
        = f_MtoG_oNBI_2obj(weight, beta1, normal1, phi1, fo1, fk1, icut1,dim, n_dim, data_x_i)

    %data_x_i=[0.5,2.7; 1.2,2.3; 2,2.5; 2.5,1.3; 3,1.5; 3.5,0.5 ];
...
%==========================================================================
  tWall_initial = cputime;
    ...
    % write to GDX file
    GAMS.putGDX('inputcs2_nbi_o.gdx',i,j,m,c,beta,normal,f_o,phi,icut,x_i);
...
%==========================================================================
    ...
    g = GAMS(struct('model','NBI_CS2_o.gms'));
...
%==========================================================================
    ...
    if g.status == 0
        ...
        status1 = copyfile('NBI_CS2_result_o.txt', 'results2.txt');
        %status2 = copyfile('NBI_CS3_WS.log', 'log2.txt');
        status2 = copyfile('NBI_CS2_o.log', 'log2.txt');
        if status1 == 1
