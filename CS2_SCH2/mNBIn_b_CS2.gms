$title NBI test2 (mNBIn_b_CS2.gms)

$gdxin inputcs2_nbin.gdx
...
x_i(j)      initial guesses on design variable
;

$load    beta phi normal f_o f_k x_i

* ----------------------------------------------
*  Store results in the txt file
* ----------------------------------------------
file res /NBI_CS2_result_n.txt/;
put res;
