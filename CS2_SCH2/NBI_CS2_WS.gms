$title NBI test2 (NBI_CS2_WS.gms)

$gdxin inputcs2_ws.gdx
...
normal(i)   direction vector for NBI          /i1=-1, i2=-2/
f_o(i)      origin to shift the objective space /i1=0, i2=0/
beta(m)     dummy /m1=0,m2=0/
w(i)        weights for weighted sum
*/i1=0.25,    i2= 0.75/
phi(i,m)
...
* ----------------------------------------------
file res /NBI_CS2_WS_result.txt/;
put res;
...
CONST_01 ..  power((x('j1')-2),3)/2 + x('j2') -2.5 =l= 0 ;
CONST_02 ..  x('j1')+x('j2')-8*power((x('j2')-x('j1')+0.65),2)-3.85 =l=0;
...
model Weight_cs2  /OBJ_w,OBJ_F1,OBJ_F2,CONST_01,CONST_02/;
...
solve Weight_cs2 using nlp minimising objective_w;

put obj_f.L('i1'):15:10,':',obj_f.L('i2'):15:10,':',x.L('j1'):15:10,':',x.L('j2'):15:10,':', objective_w.l:15:10,':',objective_w.l:15:10,':',objective_w.l:15:10,':',Weight_cs2.etSolve:15:10,':',Weight_cs2.etSolver:15:10,':',Weight_cs2.modelStat:15:10//;
obj_f.L('i1')=0;
obj_f.L('i2')=0;
