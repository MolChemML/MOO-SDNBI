...
%==========================================================================
  tWall_initial = cputime;
    ...
    % write to GDX file
    GAMS.putGDX('inputcs2_nbi.gdx',i,j,m,c,beta,normal,f_o,phi,icut,x_i);
...
%==========================================================================
    ...
    g = GAMS(struct('model','NBI_CS2.gms'));
    g.run; 
...
%==========================================================================
    ...
    if g.status == 0
        ...
        status1 = copyfile('NBI_CS2_result.txt', 'results2.txt');
        %status2 = copyfile('NBI_CS3_WS.log', 'log2.txt');
        status2 = copyfile('NBI_CS2.log', 'log2.txt');
        if status1 == 1
