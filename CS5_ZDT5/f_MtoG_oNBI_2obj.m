...
for i=1:size(data_x_i,1)
    ...
    data_initial = data_x_i(i,2:end);
    data_yo_i = data_x_i(i,1);
...
%==========================================================================
  tWall_initial = cputime;
    ...
    % write to GDX file
    GAMS.putGDX('inputcs5_nbi.gdx',i,j,m,beta,normal,f_o,phi,y_i,yo_i);
...
%==========================================================================
    ...
    g = GAMS(struct('model','NBI_CS5_ZDT5_o.gms'));
...
%==========================================================================
    ...
    if g.status == 0
        ...
        status2 = copyfile('NBI_CS5_ZDT5_o.log', 'log2.txt');
        if status1 == 1
