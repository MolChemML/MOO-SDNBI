...
% Load necessary data
load('PPoints_CS3_mNBI.mat'); load('PPoints_CS3_oNBI.mat');
...
dTol            = 0.002;  % Convergence critera for the algorithm (error between inner and outer)
sTol            = 0.035;    % Convergence criteria for the algorithm (spreadness) 
dMeasure        = 0.002;   % To check (spreadness) 
